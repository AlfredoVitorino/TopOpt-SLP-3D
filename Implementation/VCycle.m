function [x] = VCycle(A,b,x0,niter1,niter2,ngrids,nv,smoother,P,M,L,U,R,perm,opchol,opcond,pcgp)
...
if(nv == ngrids-1)
    ...
    eH = VCycle(A,rH,zeros(length(rH),1),niter1,niter2,ngrids,nv+1,smoother,P,M,L,U,R,perm,opchol,opcond,pcgp); 
end
eh = P{nv}*eH;
x = x + eh; 
